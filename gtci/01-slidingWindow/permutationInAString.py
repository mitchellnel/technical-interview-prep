def pattern_in_string(string, pattern):
    char_freqs = {}
    ...
    for window_end in range(len(string)):
        ...
        # if we've matched all the characters our frequency map, we're done
...
def main():
    print("Permutation exist: " + str(pattern_in_string("oidbcaf", "abc")))
    print("Permutation exist: " + str(pattern_in_string("odicf", "dc")))
    print("Permutation exist: " + str(pattern_in_string("bcdxabcdy", "bcdyabcdx")))
    print("Permutation exist: " + str(pattern_in_string("aaacb", "abc")))
